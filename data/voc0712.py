...
VOC_CLASSES = ( '__background__', # always index 0
    'aquarium', 'bottle', 'bowl', 'box',
    'bucket', 'plastic_bag', 'plate', 'styrofoam', 'tire',
...
class VOCDetection(data.Dataset):
    ...
    def __init__(self, root, image_sets, preproc=None, target_transform=AnnotationTransform(),
        ...
        self._imgpath = os.path.join('%s', 'test_image', '%s.jpg')
        self.ids = list()
    ...
    def __getitem__(self, index):
        img_id = self.ids[index]
        target = ET.parse(self._annopath % (img_id[0][:-1],img_id[1])).getroot()
    ...
    def _do_python_eval(self, output_dir='output'):
        ...
        use_07_metric = True if 2007 < 2010 else False
